...
static __device__ __forceinline__ T vec_dot_fattn_vec_KQ_tq4_0(
    ...
    const block_ktq4_0 * K_tq4 = (const block_ktq4_0 *) K_c;
    GGML_UNUSED(Q_v);
...
static __device__ __forceinline__ T vec_dot_fattn_vec_KQ_tq3_0(
    ...
    const block_ktq3_0 * K_tq3 = (const block_ktq3_0 *) K_c;
    GGML_UNUSED(Q_v);
...
static __device__ __forceinline__ T vec_dot_fattn_vec_KQ_tq2_0(
    ...
    const block_ktq2_0 * K_tq2 = (const block_ktq2_0 *) K_c;
    GGML_UNUSED(Q_v);
...
static __device__ __forceinline__ T vec_dot_fattn_vec_KQ_tq2_1(
    ...
    const block_ktq2_1 * K_tq2_1 = (const block_ktq2_1 *) K_c;
    GGML_UNUSED(Q_v);
...
// ── LeanKV TurboQuant dequantize_1 for FA vec path ──────────────────
...
static __device__ __forceinline__ T dequantize_1_tq2_1(const void * __restrict__ vx, const int64_t i) {
    ...
    if (pos < 32) {
        ...
        const int norm  = pos - 32;
        const int blk   = norm / 32;
        const int local = norm % 32;
        float d;
        const uint8_t * qs;
        switch (blk) {
...
constexpr __device__ vec_dot_KQ_f16_t get_vec_dot_KQ_f16(ggml_type type_K) {
    return type_K == GGML_TYPE_Q4_0   ? vec_dot_fattn_vec_KQ_q4_0<half, Dk>   :
           ...
           type_K == GGML_TYPE_KTQ4_0  ? vec_dot_fattn_vec_KQ_tq4_0<half, Dk>  :
           type_K == GGML_TYPE_KTQ3_0  ? vec_dot_fattn_vec_KQ_tq3_0<half, Dk>  :
           type_K == GGML_TYPE_KTQ2_0  ? vec_dot_fattn_vec_KQ_tq2_0<half, Dk>  :
           type_K == GGML_TYPE_KTQ2_1  ? vec_dot_fattn_vec_KQ_tq2_1<half, Dk>  :
...
constexpr __device__ vec_dot_KQ_f32_t get_vec_dot_KQ_f32(ggml_type type_K) {
    return type_K == GGML_TYPE_Q4_0   ? vec_dot_fattn_vec_KQ_q4_0<float, Dk>   :
           ...
           type_K == GGML_TYPE_KTQ4_0  ? vec_dot_fattn_vec_KQ_tq4_0<float, Dk>  :
           type_K == GGML_TYPE_KTQ3_0  ? vec_dot_fattn_vec_KQ_tq3_0<float, Dk>  :
           type_K == GGML_TYPE_KTQ2_0  ? vec_dot_fattn_vec_KQ_tq2_0<float, Dk>  :
           type_K == GGML_TYPE_KTQ2_1  ? vec_dot_fattn_vec_KQ_tq2_1<float, Dk>  :
...
constexpr __device__ dequantize_1_f16_t get_dequantize_1_f16(ggml_type type_V) {
    return type_V == GGML_TYPE_Q4_0   ? dequantize_1_q4_0<half> :
           ...
           type_V == GGML_TYPE_KTQ4_0  ? dequantize_1_tq4_0<half> :
           type_V == GGML_TYPE_KTQ3_0  ? dequantize_1_tq3_0<half> :
           type_V == GGML_TYPE_KTQ2_0  ? dequantize_1_tq2_0<half> :
           type_V == GGML_TYPE_KTQ2_1  ? dequantize_1_tq2_1<half> :
...
constexpr __device__ dequantize_1_f32_t get_dequantize_1_f32(ggml_type type_V) {
    return type_V == GGML_TYPE_Q4_0   ? dequantize_1_q4_0<float> :
           ...
           type_V == GGML_TYPE_KTQ4_0  ? dequantize_1_tq4_0<float> :
           type_V == GGML_TYPE_KTQ3_0  ? dequantize_1_tq3_0<float> :
           type_V == GGML_TYPE_KTQ2_0  ? dequantize_1_tq2_0<float> :
           type_V == GGML_TYPE_KTQ2_1  ? dequantize_1_tq2_1<float> :
